        ...
        <div className="p-6  ">
          ...
          <div className="p-6 mt-6 bg-white ">
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="font-medium text-base font-poppins">
                  EPR Reg Nos.
                </label>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="All State Selected"
                  readOnly
                />
              </div>
              <div>
              ...
              <div>
                <label className="font-medium text-base font-poppins">FY</label>
                <select className="w-full h-[45px]  p-2 border rounded">
                  <option className="text-base">Choose...</option>
            ...
            <div className="mt-6 flex justify-start">
              <button className="p-3 bg-green-600 w-[270px] h-[52px] text-base font-poppins text-white hover:bg-green-700 rounded-[6px]">
                Add EPR Account
              </button>
            </div>
          </div>

...
<Navbar/> 
  ...
  <div className="flex justify-between flex-wrap items-center bg-white p-4 sm:p-7 border">
    <div className="w-full sm:w-auto">
      <div className="flex items-center gap-3 flex-wrap">
        <h2 className="text-xl font-semibold text-gray-900">EPR Accounts</h2>
        <span className="bg-[#EAECF0] sm:text-base text-xs text-[#0070FF] font-medium px-3 py-1 rounded-full whitespace-nowrap">
          Label text or value
        </span>
      </div>
  ...
  <div className="p-4 sm:p-6 mt-6 bg-white">
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
      <div>
        <label className="font-medium text-sm sm:text-base font-poppins whitespace-nowrap">Target Quantity</label>
      ...
      <div>
        <label className="font-medium text-sm sm:text-base font-poppins whitespace-nowrap">State</label>
        <input className="w-full p-2 border rounded bg-gray-100" placeholder="All State Selected" readOnly />
      </div>
      <div>
        <label className="font-medium text-sm sm:text-base font-poppins whitespace-nowrap">Waste Type</label>
        <select className="w-full h-[45px] p-2 border rounded">
          <option className="text-base">Choose...</option>
      ...
      <div>
        <label className="font-medium text-sm sm:text-base font-poppins whitespace-nowrap">Credit Type</label>
      ...
      <div>
        <label className="font-medium text-sm sm:text-base font-poppins whitespace-nowrap">FY</label>
        <select className="w-full h-[45px] p-2 border rounded">
          <option className="text-base">Choose...</option>

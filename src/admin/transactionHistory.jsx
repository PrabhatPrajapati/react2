...
<div className="mb-4">
  ...
  <p className="text-gray-500 font-light text-base">List of offers you’ve received!</p>
</div>

{[1, 2].map((_, index) => (
  <div key={index} className="bg-white shadow-md rounded-[5px] p-6 border border-gray-200 w-[1095px] h-[286px] relative">
    ...
    {/* Title and Subtitle */}
    <p className="text-gray-400 text-base font-light mb-2">Credit Type | Waste Type</p>
    ...
    <div className="grid grid-cols-4 gap-y-6 gap-x-24 text-sm text-gray-900">
      ...
      <div>
        <p className="font-medium text-sm">Total Price (incl. GST) (Rs)</p>
        <p className='text-xs font-light'>Tonne</p>
      </div>
      <div>
    ...
    <div className="absolute bottom-9 right-14">
      <button className="flex items-center gap-2 text-sm font-medium" style={{ color: '#3D9836' }}>

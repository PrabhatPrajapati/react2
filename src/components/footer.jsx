    ...
    <>
      <footer class="w-full">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          {/* <!--Grid--> */}
          <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-8 py-14 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              <div class="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                ...
                >
                  <svg
                    class="w-[1.25rem] h-[1.125rem] text-black"
                    viewBox="0 0 15 15"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                >
                  <svg
                    class="w-[1rem] h-[1rem] text-black"
                    viewBox="0 0 13 12"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                >
                  <svg
                    class="w-[1.25rem] h-[0.875rem] text-black"
                    viewBox="0 0 16 12"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >

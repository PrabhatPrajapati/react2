      ...
      >
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20  text-center lg:pt-32 ">
          <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
            <span class="inline-block text-3xl sm:text-7xl font-poppins font-semibold text-[64px]">
              Discover the world's{" "}
            </span>

            <span class="inline-block text-3xl sm:text-7xl font-poppins  font-semibold  text-slate-900 text-[64px]">
              top designers
            </span>
          </h1>

          <p class="mx-auto mt-9 max-w-2xl text-lg tracking-tight  text-slate-700 sm:mt-6">
            <span class="inline-block font-poppins font-normal text-[24px] ">
          ...
          <div class="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
            <div class="relative w-full max-w-3xl mx-auto bg-white rounded-full">
              <input
                placeholder="What are you looking for ?"
                class="rounded-full w-full h-[74px]  bg-sky-50 py-2 pl-8 pr-32 outline-none  shadow-md hover:outline-none "
                type="text"
                name="query"
                id="query"
              />
              <button
                type="submit"
                class="absolute inline-flex items-center h-[54px] w-[54px] p-[12px] rounded-full  text-white   right-3 top-3 bg-[#04A2D1]     "
              >
                <svg
                  class=" ml-1 w-5 h-5 "
          ...
          <div class=" hidden sm:grid sm:grid-cols-2 md:grid-cols-4 lg:flex lg:flex-row justify-center gap-y-5 md:gap-y-5 gap-x-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6 mt-12">
            ...
            >
              <button
                class="group inline-flex ring-1 items-center font-poppins justify-center rounded-full py-1 px-5 text-sm text-[14px] focus:outline-none bg-[#F6F6F6] ring-[#F6F6F6] w-28 text-slate-700 hover:text-slate-900  focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right"
                id="headlessui-menu-button-:r4:"
                aria-haspopup="true"
                aria-expanded="false"
                data-headlessui-state=""
            ...
            >
              <button
                class="group inline-flex ring-1 items-center  justify-center rounded-full py-1 px-5 text-sm text-[14px] bg-[#F6F6F6] ring-[#F6F6F6] w-28text-slate-700 hover:text-slate-900  focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right font-poppins"
                id="headlessui-menu-button-:r4:"
                aria-haspopup="true"
                aria-expanded="false"
                data-headlessui-state=""
            ...
            >
              <button
                class="group inline-flex ring-1 items-center font-poppins justify-center rounded-full  text-[14px] py-1 px-5 text-sm bg-[#F6F6F6] ring-[#F6F6F6] w-28text-slate-700 hover:text-slate-900  active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right"
                id="headlessui-menu-button-:r4:"
                aria-haspopup="true"
                aria-expanded="false"
                data-headlessui-state=""
            ...
            >
              <button
                class="group inline-flex ring-1 items-center font-poppins justify-center rounded-full text-[14px] py-1 px-5 text-sm bg-[#F6F6F6] ring-[#F6F6F6] w-28 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right"
                id="headlessui-menu-button-:r4:"
                aria-haspopup="true"
                aria-expanded="false"
                data-headlessui-state=""
            ...
            >
              <button
                class="group inline-flex ring-1 font-poppins items-center justify-center rounded-full py-1 px-5 text-[14px]  bg-[#F6F6F6] ring-[#F6F6F6] w-28 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right"
                id="headlessui-menu-button-:r4:"
                aria-haspopup="true"
                aria-expanded="false"
                data-headlessui-state=""
      ...
      <section class="py-10 relative ">
          ...
          <div className="grid grid-cols-5 gap-3 sm:flex-row gap-y-5 sm:mt-10 sm:gap-y-0 sm:gap-x-6">
            {["Plastic", "Ewaste", "Batteries", "Tyres", "Used Oil"].map(
              (item, index) => (
                <button
                  key={index}
                  className="group inline-flex ring-1 font-poppins items-center justify-center rounded-full py-1 px-5 text-[14px]  bg-white ring-white w-28 text-slate-700 hover:text-white  hover:bg-sky-600 "
                >
                  {item}
                </button>
              )
        ...
        <div class="w-full mx-auto py-10 px-4 md:px-8 max-w-7xl">
          ...
          <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="bg-gradient-to-r w-[383px] h-[380px] from-blue-500 to-teal-400 rounded-lg shadow-md p-6 flex flex-col items-start ">
            ...
            {/* Card 3 */}
            <div className="bg-gradient-to-r from-green-500 to-teal-400 rounded-lg shadow-md p-6 flex flex-col items-start w-[387px] h-[380px]">
              <div className="mt-auto">

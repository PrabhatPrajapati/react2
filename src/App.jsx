...
function App() {
  ...
  const hideHeaderFooterRoutes = ['/login', '/signup' ,'/Admin','/createoffers','/dashboard','/createoffers2','/transactionHistory','/eprAccount','/createOffers3','/dashboard2','/eprAccount2','/eprAccount3','/eprAccount4','/eprAccount5','/eprAccount6'];
